...
namespace NFine.Data
{
    ...
    public class RepositoryBase<TEntity> : IRepositoryBase<TEntity> where TEntity : class,new()
    {
        ...
        public int Insert(string strSql, DbParameter[] dbParameter)
        {
            int result = dbcontext.Database.ExecuteSqlCommand(strSql,dbParameter);
            return result;
        }
        ...
        public int Update(string strSql, DbParameter[] dbParameter)
        {
            int result = dbcontext.Database.ExecuteSqlCommand(strSql, dbParameter);
            return result;
        }
        ...
        public List<TEntity> FindList(Pagination pagination)
        {
            ...
            tempData = tempData.Skip<TEntity>(pagination.page).Take<TEntity>(pagination.rows).AsQueryable();
